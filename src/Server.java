...
public class Server {
    ...
    public void start() {
        ...
        try {
            ...
            while (keepGoing) {
                ...
                ClientThread t = new ClientThread(socket); //mak a thread of it
    ...
    synchronized void remove(int id) {
        //scan the arraylist until we found id
        for (int i = 0; i < al.size(); i++) {
            ClientThread ct = al.get(i);
            //found it
            if (ct.id == id) {
    ...
    public static void main(String[] args) {
        ...
        //create a server object and start id
    ...
    class ClientThread extends Thread {
        ...
        String username;
        //the only type of message will be receive
        ChatMessage cm;
        //the date I connect
        String date;
        ...
        public void run() {
            ...
            while (keepGoing) {
                //read a Streing (which is an Object)
                try {
                ...
                switch (cm.getType()) {
                    ...
                    case ChatMessage.LOGOUT:
                        display(username + " disconnection with LOGOUT message.");
                        keepGoing = false;
                        break;
